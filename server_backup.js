    ...
    res.end(`
      ...
      <body>
        ...
        <div style='text-align: center; margin-bottom: 20px; color: #666; font-size: 0.9em;'>
          🔄 التوكنات محفوظة تلقائياً وتستمر المراقبة حتى بعد إعادة تشغيل البرنامج
        </div>
        ...
        ${Object.values(trackedTokens)
          ...
          .map(t => {
            ...
            const statusIcon = t.browserFailed ? '⚠️' : (t.reached50 ? '✅️' : '❌️');
            const statusText = t.browserFailed ? 'فشل المتصفح' : (t.reached50 ? 'وصل 50%+' : 'لم يصل بعد');
